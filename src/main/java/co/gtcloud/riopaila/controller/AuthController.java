package co.gtcloud.riopaila.controller;

import org.springframework.web.bind.annotation.*;

import co.gtcloud.riopaila.dto.LoginRequestDto;
import co.gtcloud.riopaila.dto.TokenResponseDto;
import co.gtcloud.riopaila.repository.UsuarioRepository;
import co.gtcloud.riopaila.security.jwt.JwtService;
import co.gtcloud.riopaila.security.jwt.UserDetailsImpl;
import co.gtcloud.riopaila.service.IUsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<TokenResponseDto> login(@RequestBody LoginRequestDto request) {
       ...
       // LoginRequestDto loginProcesado = new LoginRequestDto(request.username(), claveCifrada);
        ...
        // IMPORTANTE: AquÃ­ debes persistir el refreshToken en SQL Server asociado al usuario
